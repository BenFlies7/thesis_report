\section{Introduction}
  ...
  \subsection{The cancer genome}
    ...
    \subsubsection{Driver and passenger mutations}
      ...
      histologic, anatomic and pathologic alterations. With the success of
      molecular biology in the last decades, several models describing the
      molecular progression in the respective cancer types were postulated.
      This enabled experts to identify potential targets for personalized
      medicine.
  ...
  \subsection{Tumor DNA Sequencing}
    ...
    Several factors are responsible for the fact that NGS is not yet widely
