\section{Introduction}
  ...
  \subsection{Tumor DNA Sequencing}
    ...
    \subsubsection{Practical implications in the laboratory}
      ...
      several bioinformatic algorithms and tools exist {\cite{tools}}. The computational
      ...
      detection rates {\cite{calling_1}} {\cite{calling_2}}. These tools have to be carefully assessed, as
